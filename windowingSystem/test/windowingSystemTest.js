...
import { Position, ProgramWindow, Size, changeWindow } from "../src/windowingSystem";

describe("Define Size for storing the dimensions of the window", () => {
...
describe("Define Position to store a window position", () => {
    test("allows to create a new instance", () => {
...
describe("Define a ProgramWindow class", () => {
    test("allows to create a new instance", () => {
...
describe("Add a method to resize the window", () => {
    test("provides a resize method", () => {
...
describe("Add a method to move the window", () => {
...
describe("Change a program window", () => {
